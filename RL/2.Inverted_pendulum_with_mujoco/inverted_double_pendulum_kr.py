...
# 카트폴처럼 막대 달린 카트 제어
#ENV_NAME = "CartPole-v1"                # 불안정한 막대를 수직으로 유지하기

LEARNING_RATE  = 1e-5                         # 학습률: 올리면 빠르게 배우지만 불안정해지고, 내리면 느리지만 안정적이에요
...
FINAL_MODEL_NAME = "ppo_InvertedDoublePendulum_final.pth"
