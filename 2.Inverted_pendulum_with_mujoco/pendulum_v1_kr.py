...
LEARNING_RATE  = 1e-3                        # 학습률: 올리면 빠르게 배우지만 불안정해지고, 내리면 느리지만 안정적이에요
GAMMA          = 0.98                        # 할인율: 올리면 먼 미래 보상 중시해 장기 전략을 배우지만 불안정해지고, 내리면 단기 집중해 빠르게 반응해요
...
ROLLOUT_LENGTH = 1024                         # 롤아웃 길이: 올리면 보상 추정이 안정적이지만 업데이트 간격이 길어지고, 내리면 자주 업데이트하지만 불안정해져요
